...
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- printf "%s-%s" $name .Values.alertmanager.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- printf "%s-%s" $name .Values.kubeStateMetrics.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- printf "%s-%s" $name .Values.nodeExporter.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
